  ...
  return (
    <div className="bg-white  min-h-screen w-screen overflow-hidden pb-10  font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col ">
        ...
        <Image className='rounded-full rounded-b-none  h-[29rem] md:h-full w-full object-cover' src='https://plus.unsplash.com/premium_photo-1701984401462-f1c709ce722e?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt='baby smiling' />

        <div className=" h-auto w-full  p-2 min-h-96 bg-[#e6eeb7] rounded-b-full  ">
