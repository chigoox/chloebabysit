      ...
      <main className="flex flex-col ">
        ...
        <div className="mt-20 center-col p-2">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 ">
            <Button onPress={() => { push('/FindMyNanny') }} className='m-auto rounded-none p-6 text-xl  bg-[#f26d5c]'>Find Your Nanny</Button>
            <Button onPress={() => { push('/FindMyFamily') }} className='bg-opacity-0 rounded-none text-xl'>Find Your Family <AiOutlineArrowRight /></Button>
          </div>
        </div>

        <div className=' h-auto flex flex-col lg:flex-row-reverse items-center justify-center  xl:p-40 trans'>

          <div className=' h-48 md:h-full  w-full flex  overflow-hidden  md:overflow-visible relative'>
            <Image className='md:h-[30rem] w-screen md:w-[60rem] lg:shadow shadow-black  lg:rounded-r-full relative bottom-20 md:bottom-0 md:top-0 xl:right-[15rem] rounded-none object-cover' src='https://www.kindercare.com/-/media/kindercare/images/personalization/kclc_homepage_personalization_image_morethandaycare.jpg?h=800&w=1200&la=en&hash=60AA673220CF3A5251988AF34920CAC2' alt='baby smiling' />
          </div>
          ...
          <div className='bg-[#e6eeb7] flex-shrink-0 h-auto md:h-[45rem] p-4 justify-center l:w-[80%]  lg:w-[55%]  flex flex-col '>
            ...
            <Button onPress={() => { push('/AboutUs') }} className='w-fit bg-[#abbc4e] rounded-none p-8'>Why Nannies by Chloes?</Button>
          </div>
        ...
        <div className='m-auto relative md:h-auto rounded-none lg:p-20 flex flex-col md:flex-row trans'>

          <Image className='rounded-full rounded-t-none  h-[29rem] md:h-full lg:w-64 object-cover' src='https://plus.unsplash.com/premium_photo-1663126735125-5b2358492ab8?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt='baby smiling' />
          <div className='grid lg:gap-8 md:gap-6 lg:grid-cols-2 grid-cols-1 p-4'>
            <div className='center-col gap-3'>
              ...
              <h1 className='text-center w-64'>Complete our simple form to begin the process and we’ll schedule a complimentary call to talk about your family’s needs.</h1>
            </div>

            <div className='center-col gap-3'>
              <h1 className='text-5xl text-center font-bold'>02</h1>
              <h1 className='text-3xl text-center'>We make your list & check it twice.</h1>
              <h1 className='text-center w-64'>If we’re the right fit, we’ll take a deep dive on a consultation call. Tell us your wish list, and we’ll do the rest</h1>
            </div>

            <div className='center-col gap-3'>
              <h1 className='text-5xl text-center font-bold'>03</h1>
              <h1 className='text-3xl text-center'>Say yes to the very best.</h1>
              <h1 className='text-center w-64'>We’ll connect you with not only the savviest and most dedicated care providers, but the best of the best!</h1>
            </div>

            <div className='center-col gap-3'>
              <h1 className='text-5xl text-center font-bold'>04</h1>
              <h1 className='text-3xl text-center'>Interviewed, trialed, ready to hire?</h1>
              <h1 className='text-center w-64'>We’ll help you define an offer & work agreement that sets up a strong foundation and incentivizes longevity and transparency.</h1>
            </div>
        ...
        <Image className='rounded-full m-auto rounded-b-none lg:w-1/2  h-[29rem] md:h-full w-full object-cover' src='https://plus.unsplash.com/premium_photo-1701984401462-f1c709ce722e?q=80&w=2670&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' alt='baby smiling' />
